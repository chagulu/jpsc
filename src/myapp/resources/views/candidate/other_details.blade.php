...
<head>
  ...
  <title>Candidate Dashboard - Other Details</title>
...
<div class="d-flex" id="wrapper">
  ...
  <div class="sidebar bg-dark text-white p-3" style="min-width:220px;">
    ...
    <a href="other-details.html" class="d-block text-light mb-2 active"><i class="fas fa-info-circle mr-2"></i> Other Details</a>
  ...
  <div class="flex-grow-1 d-flex flex-column">
    ...
    <div class="container-fluid">
      <ul class="progressbar">
        ...
        <li class="active"><a href="other-details.html">Other Details</a></li>
